		...
		<footer className='bg-neutral-950 pt-24 pb-12 border-t border-white/10'>
			<div className='max-w-7xl mx-auto px-6'>
				<div className='grid grid-cols-1 md:grid-cols-4 gap-12 mb-16'>
					<div className='col-span-1 md:col-span-2'>
						<Link href='/' className='flex items-center gap-2 mb-8'>
							...
							<div className='flex flex-col'>
								<span className='font-serif text-xl leading-none tracking-widest text-white'>
									Qabas
								</span>
						...
						<p className='text-neutral-400 text-sm leading-relaxed max-w-md mb-8'>
							Specializing in the sale and acquisition of the finest properties
							in Prime Central London. A legacy of trust, discretion, and
							exceptional results.
						</p>
						<div className='flex gap-4'>
							<a
								href='mailto:Qabasalani1@gmail.com'
								aria-label='Email'
								className='w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white hover:border-gold hover:text-gold hover:shadow-[0_0_12px_rgba(212,175,55,0.5)] transition-all duration-300'
							>
								<svg
									className='w-4 h-4'
									fill='none'
					...
					<div>
						<div className='text-white font-serif text-lg mb-6'>Navigation</div>
						<ul className='space-y-4'>
							{footerNavItems.map((item) => (
								<li key={item}>
									<RollLink
										href={`/#${item.toLowerCase()}`}
										className='text-neutral-400 uppercase tracking-wider text-[11px]'
									>
										{item}
									</RollLink>
								</li>
					...
					<div>
						<div className='text-white font-serif text-lg mb-6'>Contact</div>
						<ul className='space-y-4'>
				...
				<div className='border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4'>
					<p className='text-neutral-400 text-[10px] uppercase tracking-widest'>
						© {new Date().getFullYear()} Qabas Real Estate. All Rights
						Reserved.
					</p>
					<div className='flex gap-8'>
						<RollLink
							href='#'
							className='text-neutral-400 text-[10px] uppercase tracking-widest'
						>
							Privacy Policy
						</RollLink>
						<RollLink
